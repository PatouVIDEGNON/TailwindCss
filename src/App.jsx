...
<div className="min-h-screen flex items-center bg-teal-500">
  ...
  <ul className="grid grid-rows-4 grid-cols-6 gap-8 grid-flow-col-dense"> 
            <li className="  bg-gray-800 rounded-lg shadow-xl "><div className="h-24"> grid grid-cols-1 gap-4  </div></li>
            <li className=" row-span-4 bg-pink-600 rounded-lg shadow-xl"><div className="h-24">sm:grid-cols-2 sm:gap-4 </div></li>
